...
<div class="row chat-row">
    <div class="col-md-3">
        ...
        <div class="groups mt-5">
            <h5>Groups <i class="fa fa-plus btn-add-group ml-3" data-bs-toggle="modal"
                    data-bs-target="#addGroupModal"></i></h5>
...
@include("message.components.addGroupModal")
...
<script type="module">
    $(function (){
       ...
       $('.selectMember').select2({
        multiple: true,
        placeholder: 'Selecciona nuevos miembros'
        });
</script>
@endpush